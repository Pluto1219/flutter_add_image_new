...
//        data.createSubdirectory("3.0x");
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                frame.setTitle("Flutter Add Image New -- Drag File To Here ----> " + psiDirectory.getName());
...
//                    field.setText(filepath);
    ...
    void init() {
        ...
        WriteCommandAction.runWriteCommandAction(project, new Runnable() {
            ...
            public void run() {
                try {
                    gen_a = lib.findChild("generated");
                    if (gen_a == null) {
                        gen_a = lib.createChildDirectory(null, "generated");
                    }
...
//                                    PsiFile fileFromText = PsiFileFactory.getInstance(project).createFileFromText(Language.ANY, "images.dart");
    ...
    void gen_AContent() {
        ...
        while (iterator.hasNext()) {
            ...
            sb.append("  static const String " + Tool.lineToHump(next.getKey()) + " = '" + next.getValue() + "';\n");
        }
